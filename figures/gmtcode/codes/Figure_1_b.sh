...
gmt psbasemap -R43.5/61.5/34/40 -JM5i  -B4f2/4f2 -Y8i -V -P -K > ${PSNAME}
gmt grdimage etopo1_bedrock.grd -R -J -Bwnes  -CGMT_globe.cpt  -V -O -K >> ${PSNAME}
...
#Tehran
cat << EOF13 |gmt psxy -Sa0.4  -W1 -R$REGION $PROJ -G200/0/0 -K -O  >> ${PSNAME}
51.39	35.7
EOF13
